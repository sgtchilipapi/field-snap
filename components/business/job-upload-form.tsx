  ...
  return (
    ...
    >
      <label className="block space-y-2">
        <span className="text-sm font-medium text-[color:var(--foreground)]">Snap or choose an image</span>
        <input
      ...
      <p className="text-sm text-[color:var(--muted)]">One image per upload. Maximum size: 15 MB.</p>
